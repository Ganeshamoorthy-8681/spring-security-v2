...
public interface UserMapper {
    ...
    @Results(id = "userWithRolesAndPermissions", value = {
            ...
            @Result(property = "lastFailedLogin", column = "last_failed_login", javaType = Instant.class),
            @Result(property = "createdBy", column = "created_by"),
            @Result(property = "updatedBy", column = "updated_by"),
            @Result(property = "deletedBy", column = "deleted_by"),
            @Result(property = "additionalAttributes", column = "additional_attributes", javaType = Map.class, typeHandler = com.spring.security.type.handlers.JsonTypeHandler.class),
    ...
    @Results(
            ...
            @Result(property = "permissions", javaType = List.class, column = "permission_id",
