...
public class UserSqlProvider {
    ...
    public String baseUserWithRolesAndPermissionsQuery(String whereClause) {
        String query = new SQL() {{
            SELECT("u.id AS user_id, u.first_name, u.last_name, u.middle_name, u.email, u.type, u.status, u.password, u.account_id, " +
    ...
    public String findByEmailAndAccountId(Long accountId, String email) {
        return baseUserWithRolesAndPermissionsQuery("u.email = #{email} AND u.account_id = #{accountId}");
    }
