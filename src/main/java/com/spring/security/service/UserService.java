...
public interface UserService {
   ...
   */
  UserResponseDto createRootUser(RootUserCreateRequestDto userCreateRequestDto, Long accountId)
      throws ServiceLayerException;
   ...
   */
  UserResponseDto findByAccountIdAndEmail(Long accountId, String email)
      throws ServiceLayerException;
